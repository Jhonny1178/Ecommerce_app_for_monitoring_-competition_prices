...
class ReadyScraperSpider(scrapy.Spider):
    ...
    css_map = {
        ...
        "brand": "a[href]:contains('Alessi')",
        "color": "b:contains('Kolor') + br",
        "old_price": "p.old-price span.price",
        "special_price": "p.special-price span.price",
        "breadcrumbs_wrapper": None,
        "breadcrumb_item": None,
        "specifications_row": "div:contains('Wymiary') , div:contains('Materiał') , div:contains('Kolor')",
        "spec_name": "div:nth-child(1)",
        "spec_value": "div:nth-child(2)",
