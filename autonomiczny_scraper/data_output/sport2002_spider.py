...
class GotowyScraperSpider(scrapy.Spider):
    name = "sport2002_spider"

    # Mapa CSS wygenerowana przez Twoje AI
    css_map = {
        "product_name": None,
        "product_id": "#shop_product17504",
        "brand": None,
        "color": None,
        "old_price": None,
        "special_price": None,
        "breadcrumbs_wrapper": "nav.breadcrumb",
        "breadcrumb_item": "li a",
        "specifications_row": None,
        "spec_name": None,
        "spec_value": None,
    ...
    def start_requests(self):
        sciezka_do_linkow = getattr(self, 'links_file', 'sport2002_linki.txt')
